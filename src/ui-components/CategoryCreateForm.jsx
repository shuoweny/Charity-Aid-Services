...
export default function CategoryCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setStockLevels(initialValues.stockLevels);
    setCurrentStockLevelsValue("");
    setType(initialValues.type);
    setItems(initialValues.items);
    setCurrentItemsValue("");
    setErrors({});
  };
  const [currentStockLevelsValue, setCurrentStockLevelsValue] =
    React.useState("");
  const stockLevelsRef = React.createRef();
  const [currentItemsValue, setCurrentItemsValue] = React.useState("");
  const itemsRef = React.createRef();
  const validations = {
    name: [{ type: "Required" }],
    stockLevels: [{ type: "Required" }],
    type: [{ type: "Required" }],
    items: [{ type: "Required" }],
  };
      ...
      <ArrayField
        onChange={async (items) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            values = result?.stockLevels ?? values;
          }
          setStockLevels(values);
          setCurrentStockLevelsValue("");
        }}
        currentFieldValue={currentStockLevelsValue}
        label={"Stock levels"}
        items={stockLevels}
        hasError={errors?.stockLevels?.hasError}
        errorMessage={errors?.stockLevels?.errorMessage}
        setFieldValue={setCurrentStockLevelsValue}
        inputFieldRef={stockLevelsRef}
        defaultFieldValue={""}
      >
        <TextField
          label="Stock levels"
          ...
          type="number"
          step="any"
          value={currentStockLevelsValue}
          onChange={(e) => {
            let value = isNaN(parseInt(e.target.value))
              ? e.target.value
              : parseInt(e.target.value);
            if (errors.stockLevels?.hasError) {
              runValidationTasks("stockLevels", value);
            }
            setCurrentStockLevelsValue(value);
          }}
          onBlur={() =>
            runValidationTasks("stockLevels", currentStockLevelsValue)
          }
          errorMessage={errors.stockLevels?.errorMessage}
          hasError={errors.stockLevels?.hasError}
          ref={stockLevelsRef}
          labelHidden={true}
          {...getOverrideProps(overrides, "stockLevels")}
        ></TextField>
      </ArrayField>
      <SelectField
        label="Type"
