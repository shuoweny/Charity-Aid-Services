...
export default function SideBar(props) {
  ...
  // const [sessionStorage, setSessionStorage] = React.useState(null);
        ...
        >
          ...
          >
            <Heading
              ...
              shrink="0"
              level="3"
              children={`Depot ${props == null || props.curDepot == null ? "" : props.curDepot.name}`}
          ...
          >
            ...
            >
              ...
              <Button
                ...
                shrink="0"
                size="large"
                isDisabled={props.curDepot.id == null}
                variation="default"
                children="Stock"
